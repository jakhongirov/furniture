			...
			<header className='header' id='header'>
				<div className='container'>
					<div className='header__desktop-box'>
						...
						<div className='header__box-bottom'></div>
					</div>
					...
					<div className='header__mobile-box'>
						...
						<button
							className={
								!Humopen ? 'hamburger__btn' : 'hamburger__btn--none'
							}
						...
						<ul className='header__mobile__nav__list'>
							<li className='header__mobile__nav__item'>
								<select
									...
									<option value='ru' onClick={() => setHumOpen(false)}>
										RU
									</option>
									<option value='en' onClick={() => setHumOpen(false)}>
										EN
									</option>
									<option value='uz' onClick={() => setHumOpen(false)}>
										UZ
									</option>
								</select>
							</li>
